...
//
export class PlayersViewGrid extends CursorGrid {
    ...
    static defaultProps  = {
        ...
        baseRoute: "/app/player"
    }

    contributeActionBar() {
        return (
            <div key="main">
                <Link to={`${this.props.baseRoute}`} className="btn btn-primary">Create New Player</Link>
            </div>
        );
    }
}
...
//
export default class PlayersView extends CursorPage {
    ...
    render() {
        return (
            <div>
                ...
                <div>
                    <PlayersViewGrid height={this.state.gridHeight}/>
                </div>
            </div>
        )
    }
